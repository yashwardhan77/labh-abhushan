...
export default async function HomePage() {
  ...
  return (
    <div className="w-full flex flex-col">
      ...
      <section className="relative z-20 -mt-16 max-w-5xl mx-auto w-full px-4 mb-16">
        <div className="bg-emerald-950 text-white rounded-2xl border border-gold-500/30 p-6 sm:p-8 shadow-2xl relative overflow-hidden">
          {/* Decorative Gold Glow */}
          <div className="absolute -top-24 -left-24 w-48 h-48 rounded-full bg-gold-500/10 blur-3xl" />
          <div className="absolute -bottom-24 -right-24 w-48 h-48 rounded-full bg-gold-500/10 blur-3xl" />

          {/* Header */}
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-b border-gold-500/15 pb-4 mb-6">
            <div className="flex items-center gap-2.5">
              <span className="flex h-3 w-3 relative">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-3 w-3 bg-emerald-500"></span>
              </span>
              <h2 className="font-serif text-lg sm:text-xl tracking-wider text-gold-400 font-semibold uppercase">
                Today's Live Showroom Rates
              </h2>
            </div>
            <p className="text-xs text-gray-400 tracking-wide">
              Last Updated: {rates.updated_at ? formatDate(rates.updated_at) : 'Just now'}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            {/* 24K Gold */}
            <div className="bg-emerald-900/30 rounded-xl p-4 border border-gold-500/10">
              <p className="text-xs tracking-widest text-gold-500/80 uppercase font-medium mb-1">
                Gold 24K <span className="text-[10px] text-gray-400 font-sans">(per 10g)</span>
              </p>
              <p className="text-2xl sm:text-3xl font-serif font-bold text-white tracking-wide">
            ...
            <div className="bg-emerald-900/30 rounded-xl p-4 border border-gold-500/10">
              <p className="text-xs tracking-widest text-gold-500/80 uppercase font-medium mb-1">
                Gold 22K <span className="text-[10px] text-gray-400 font-sans">(per 10g)</span>
              </p>
              <p className="text-2xl sm:text-3xl font-serif font-bold text-white tracking-wide">
            ...
            <div className="bg-emerald-900/30 rounded-xl p-4 border border-gold-500/10">
              <p className="text-xs tracking-widest text-gold-500/80 uppercase font-medium mb-1">
                Silver <span className="text-[10px] text-gray-400 font-sans">(per 1 kg)</span>
              </p>
              <p className="text-2xl sm:text-3xl font-serif font-bold text-white tracking-wide">
          ...
          <p className="text-[10px] text-gray-400 text-center mt-6 tracking-wide">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="text-gold-500 font-serif tracking-[0.2em] uppercase text-sm font-semibold mb-2 block">
              Curated Masterpieces
            </span>
            <h2 className="text-3xl sm:text-4xl font-serif text-emerald-950 font-bold uppercase tracking-wider mb-4">
              Featured Ornaments
            </h2>
          ...
          {featuredProducts.length === 0 ? (
            <div className="text-center py-12 border border-dashed border-gold-500/20 rounded-xl bg-gold-50/5">
              ...
              <p className="text-gray-500 font-medium">New collection launching soon. Stay tuned!</p>
              <Link
                href="/products"
                className="inline-flex items-center gap-1 text-gold-600 hover:text-gold-500 font-semibold text-sm mt-4 cursor-pointer"
              >
            ...
            <>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                {featuredProducts.map((product) => {
                  ...
                  return (
                    <div
                      key={product.id}
                      className="group bg-gold-50/5 rounded-xl overflow-hidden border border-gold-500/10 hover:border-gold-500/30 transition-all duration-300 flex flex-col justify-between shadow-sm hover:shadow-lg"
                    >
                      {/* Product Image */}
                      ...
                      <div className="p-5 flex flex-col flex-grow justify-between gap-4">
                        ...
                        <div className="flex gap-2">
                          <Link
                            ...
                            className="flex-1 text-center py-2 rounded border border-gold-500 text-gold-600 text-xs font-semibold hover:bg-gold-500 hover:text-emerald-950 transition-colors cursor-pointer"
                          >
                            Details
                          </Link>
                          <a
                            ...
                            className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded gold-gradient text-emerald-950 text-xs font-bold hover:opacity-90 transition-opacity cursor-pointer"
                          >
              ...
              <div className="text-center mt-12">
                <Link
                  href="/products"
                  className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full gold-gradient text-emerald-950 font-bold uppercase tracking-wider text-xs shadow-md hover:scale-[1.02] active:scale-[0.98] transition-all cursor-pointer"
                >
      ...
      <section className="py-20 bg-gold-100/10 border-y border-gold-500/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="text-gold-500 font-serif tracking-[0.2em] uppercase text-sm font-semibold mb-2 block">
              Our Legacy
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {/* Item 1 */}
            <div className="bg-white rounded-xl p-6 border border-gold-500/10 text-center shadow-sm hover:shadow-md transition-shadow">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Quote 1 */}
            <div className="bg-gold-50/10 rounded-xl p-6 border border-gold-500/10 relative flex flex-col justify-between shadow-sm">
              <div>
      ...
      <section className="py-20 bg-emerald-950 text-white border-t border-gold-500/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* Showroom Details */}
            <div className="flex flex-col gap-6">
              <span className="text-gold-400 font-serif tracking-[0.2em] uppercase text-sm font-semibold">
                Visit Our Showroom
              </span>
              <h2 className="text-3xl sm:text-4xl font-serif font-bold uppercase tracking-wider">
                We'd Love To Welcome You
              </h2>
              <div className="h-0.5 w-24 gold-gradient" />
              ...
              <div className="flex gap-4 mt-6">
                <a
                  href={`tel:${PHONE_NUM}`}
                  className="flex items-center gap-2 px-6 py-3 rounded-full border border-gold-500 text-gold-400 text-xs font-semibold uppercase tracking-wider hover:bg-gold-500 hover:text-emerald-950 transition-colors cursor-pointer"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-6 py-3 rounded-full gold-gradient text-emerald-950 text-xs font-bold uppercase tracking-wider hover:opacity-90 transition-opacity cursor-pointer"
                >
